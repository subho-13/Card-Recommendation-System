...
public class TransactionConverterTest {
    ...
    public void converterTest() throws ParseException {
        ...
        collectedTransaction.setMerchantCoordinate(new GeoCoordinate(40.49F,-74.19F));

        assertEquals(collectedTransaction,transactionConverter.convert(transaction)); ;
    }
