...
from repository.DatabaseHandler import save_user_details_from_feature_vector_one, save_feature_vector_one
...
def convert_to_feature_vector_one_dict(message):
    temp = {
