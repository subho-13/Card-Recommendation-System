...
public class KafkaProducerConfig {
    ...
    @Bean
    public KafkaTemplate<String, CompiledRecommendation> kafkaCompiledRecommendationTemplate(){
        JsonSerializer<CompiledRecommendation> jsonSerializer = new JsonSerializer<>();
        StringSerializer stringSerializer = new StringSerializer();
        DefaultKafkaProducerFactory<String, CompiledRecommendation> defaultKafkaProducerFactory
