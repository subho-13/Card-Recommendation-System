...
class CompilerTest {
    ...
    public void getCardConfidenceMapTest() {
        ...
        assertEquals(finalCardConfidencemap, compiler.getCardConfidenceMap(modelCardConfidenceMap));
    ...
    public void updateMapTest() {
        ...
        compiler.updateMap(modelWeightMap);
        assertEquals(modelWeightMap, compiler.getModelWeightMap() );
